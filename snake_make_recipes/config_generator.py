...
@click.command()
@click.option('--bamdir','-b', default=None, type=click.Path(exists=True), required=True,
              help='Path to the bam directory.')
@click.option('--fqdir', '-f', default=None, type=click.Path(exists=True), required=True,
...
@click.option('--gtf', '-g', default=None, type=click.Path(exists=True), required=True,
